...
public class Post extends PostID {
    private String Post_image, Post_desc, Post_thumb, Post_title, Post_date;
    public Post(){

    }
    public Post(String post_image, String post_desc, String post_thumb,String post_title,String post_date){
