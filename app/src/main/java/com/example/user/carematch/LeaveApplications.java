...
//        setStudent_name();
//
//        Log.d(TAG, "leave.setStudent_name out get:" + reservation.getStudent_name());
//
//        initDate();
...
//                apply();
//                Log.d(TAG, "leave.getTeacher_email onClick:" + reservation.getTeacher_email());
//            }
//        });
//
...
//                                reservation.setStudent_name(student_name);
//                                Log.d(TAG, "leave.setStudent_name in get:" + reservation.getStudent_name());
//                            }
//                        } else {
//                            Log.d(TAG, "Error getting documents: ", task.getException());
//                        }
...
//                                reservation.setTeacher_email(teacher_email);
//                                Log.d(TAG, "leave.getTeacher_email in get:" + reservation.getTeacher_email());
//                            }
//                        } else {
//                            Log.d(TAG, "Error getting documents: ", task.getException());
//                        }
...
//        final String student_name = reservation.getStudent_name();
...
//        final String teacher_email = reservation.getTeacher_email();
...
//
//
//        reservation.setClass_id(student_id);
//        reservation.setLeave_check(leave_check);
//        reservation.setLeave_content(leave_content);
//        reservation.setLeave_date(leave_date);
//        reservation.setLeave_reason(leave_reason);
//        reservation.setClass_name(leave_class);
//        reservation.setClass_id(class_id);
//        reservation.setLeave_uploaddate(leave_uploaddate);
//        reservation.setStudent_id(student_id);
//        reservation.setLeave_photoUrl(leave_photoUrl);
//
...
//
//        db.collection("Leave").add(reservation);
//
