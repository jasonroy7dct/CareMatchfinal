...
public class HumanCheck extends AppCompatActivity {
    ...
    private String url;
    private String name,age,exp,sex,price;
...
//                //加入Human資料庫
//
//                db.collection("Human/" + humanId + "/Care")
...
//
//
//                                        db.collection("Human/" + humanId + "/Care").document(currentUserID).set(careMap);
//                                        //點預約
//                                        DocumentReference okay  =db.collection("Human").document(humanId);
//                                        okay.update("H_ava","此時段已滿");
//
//                                    } else {
////                                        db.collection("Human/" + humanId + "/Care").document(currentUserID).delete();
//
//
//                                    }
//                                } else {
...
//                Toast.makeText(context, "預約成功，請至「我的預約」確認！" , Toast.LENGTH_SHORT).show();
//
//
//
//
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        db.collection("users/" + user_id + "/Care")
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                ...
                                Toast.makeText(HumanCheck.this,"預約成功！",Toast.LENGTH_SHORT).show();
